...
public interface AuctionService {
     ...
     *
     * @return 진행 중인 경매를 나타내는 {@link AuctionDto} 목록
     */
    List<AuctionDto> getOngoingAuctions();

    /**
     * 주어진 경매 정보로 새로운 경매를 생성하고 데이터베이스에 저장합니다.
     *
     * @param auction 생성할 경매의 정보를 포함하는 {@link Auction} 객체
     * @return 새로 생성된 경매의 {@link AuctionDto}
     */
    AuctionDto createAuction(Auction auction);
     ...
     * @return 변경 사항이 저장된 후의 업데이트된 {@link AuctionDto}
     * @throws com.leehk.auction.global.response.CustomException 지정된 식별자의 경매를 찾을 수 없는 경우
     */
    AuctionDto updateAuction(Long auctionId, Auction auction);
